        ...
        for td in data:
            ...
            for plan in PipelineConfiguration.RQA_CODING_PLANS:
                for cc in plan.coding_configurations:
                    codes = analysis_utils.get_codes_from_td(td, AnalysisConfiguration(plan.dataset_name, plan.raw_field, cc.coded_field, cc.code_scheme))
                    for code in codes:
                        if code.meta_code == "showtime_question":
                            uuids.add(td["uid"])
